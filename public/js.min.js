...
angular.module("influences").directive("forceMain",["chartService","$state",function(t,n){function r(r,e,i){var c=r.window.d3,o=c.select(e.find("svg")[0]),a=[],u=[];r.root.forEach(function(n){var r=t.format(n,"subgenres");r.nodes.forEach(function(t){a.push(t)}),r.links.forEach(function(t){u.push(t)})});var s=c.layout.force().size([width,height]).nodes(a).links(u).linkDistance(width/20).linkStrength(1).gravity(.2).friction(.7).charge(-3e3);s.start();var f=o.selectAll("lines").data(u).enter().append("line").attr("class","link").attr("x1",function(t){return t.source.x}).attr("y1",function(t){return t.source.y}).attr("x2",function(t){return t.target.x}).attr("y2",function(t){return t.target.y}),l=o.selectAll("nodes").data(a).enter().append("circle").attr("class","node").style("fill",function(t){return t.color}).attr("r",function(t){return t.r||width/80}).attr("cx",function(t){return t.x}).attr("cy",function(t){return t.y}).on("click",function(t){n.go(t.type+".show",{id:t.id})}),d=o.selectAll("text").data(a).enter().append("foreignObject").attr("class","artist").attr("x",function(t){return t.x}).attr("y",function(t){return t.y}).on("click",function(t){n.go(t.type+".show",{id:t.id})}).html(function(t){return'<span class="artist first">'+t.text[0]+"</span> "+t.text.slice(1)});s.on("tick",function(){l.attr("cx",function(t){return t.x}).attr("cy",function(t){return t.y}),f.attr("x1",function(t){return t.source.x}).attr("x2",function(t){return t.target.x}).attr("y1",function(t){return t.source.y}).attr("y2",function(t){return t.target.y}),d.attr("x",function(t){return t.x}).attr("y",function(t){return t.y})})}return{restrict:"E",template:"<svg height="+height+" width="+width+"></svg>",scope:{root:"="},controller:["$scope","$window",function(t,n){t.window=n}],link:r}}]);

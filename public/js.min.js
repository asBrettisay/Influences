...
angular.module("influences").controller("adminCtrl",["$scope","artistsList","genresList","artistService","genreService","$state","userService",function(t,e,i,n,s,o,r){this.artistsList=e,this.genresList=i,this.deleteArtist=function(t){var e=this;n.deleteArtist(t).then(function(t){n.getAllArtists().then(function(t){e.artistsList=t})})}.bind(this),this.generateInviteToken=function(){console.log("Getting token");var t=this;r.getInviteToken().then(function(e){console.log(e),t.inviteToken=e.inviteToken})}.bind(this)}]);

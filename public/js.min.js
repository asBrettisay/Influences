...
angular.module("influences").directive("searchBar",["artistService","genreService","$q",function(e,r,t){return{restrict:"AE",templateUrl:"./directives/views/searchBar.html",scope:!0,controllerAs:"vw",controller:["$scope","artistService","genreService","searchService","$state",function(e,r,t,c,i){var s=this;s.refreshItems=function(e){c.searchForName(e).then(function(e){console.log("Data from search is",e),s.items=e})},s.goTo=function(e){i.go(e.type,{id:e.id})},s.test="hello!"}]}}]);

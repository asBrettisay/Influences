...
angular.module("influences").directive("dropdownMenu",function(){return{restrict:"AE",templateUrl:"./directives/views/dropdownMenu.html",scope:{currentUser:"="},controller:["$scope","userService","$state",function(e,n,t){e.activateModal=function(n){e.$emit("activateModal",n),e.menuActive=!1},e.logoutUser=function(){n.logoutUser().then(function(){e.menuActive=!1,t.go("main",{},{reload:!0})})},e.$on("close menu",function(){e.menuActive=!1})}],link:function(e,n,t){var o=n.find("div.menuButtonContainer");o.on("mouseenter",function(){o.toggleClass("menuButtonContainerHover")}),o.on("mouseleave",function(){o.toggleClass("menuButtonContainerHover")})}}});

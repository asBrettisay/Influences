...
angular.module("influences").controller("indexCtrl",["$scope","userService",function(t,e){e.getCurrentUser().then(function(t){t&&(this.currentUser=t),console.log(this.currentUser)}.bind(this)),this.active={},t.$on("activateModal",function(t,e){console.log("Activating modal!"),this.active={},this.active.modal=!0,this.active[e]=!0}.bind(this)),t.$on("modal action complete",function(t,n){var i=this;i.active={},e.getCurrentUser(function(t){i.currentUser=t,console.log(i.currentUser)})}.bind(this))}]);
